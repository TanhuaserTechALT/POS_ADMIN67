        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                posdb_connect.pos_sql = "SELECT * FROM pos_nameTbl INNER JOIN pos_picTbl " +
                                        "ON pos_nameTbl.pos_id = pos_picTbl.pos_id INNER JOIN pos_priceTbl " +
                                        "ON pos_picTbl.pos_id = pos_priceTbl.pos_id WHERE pos_nameTbl.pos_id = '" +
          ...
          try
            {
                posdb_connect.pos_sql = "UPDATE pos_nametbl SET name1 = '" +
                    ...
                    nameTxtbox19.Text + "', name20 = '" + nameTxtbox20.Text +
                ...
                posdb_connect.pos_sql = "UPDATE pos_pictbl SET pic1 = '" +
                    ...
                    picpathTxtbox5.Text + "', pic6 = '" + picpathTxtbox6.Text + "', pic7 = '" + picpathTxtbox7.Text + "', pic8 = '" +
...
picpathTxtbox20.Text + "' WHERE pos_id = '" + pos_id_comboBox.Text + "'";
                ...
                posdb_connect.pos_sql = "UPDATE pos_priceTbl SET price1 = '" +
                    ...
                    priceTxtbox19.Text + "', price20 = '" + priceTxtbox20.Text +
                    "' WHERE pos_id = '" + pos_id_comboBox.Text + "'";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                posdb_connect.pos_sql = "DELETE FROM pos_picTbl WHERE " +
                    "pos_picTbl.pos_id = '" + pos_id_comboBox.Text + "'";
        ...
        private void pictureBox10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox10.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox9_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox9.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox7.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox8.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox11_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox11.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox12_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox12.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox13_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox13.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox14_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox14.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox15_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox15.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox16_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox16.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox17_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox17.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox18_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox18.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox19_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox19.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
        ...
        private void pictureBox20_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                openFileDialog.ShowDialog();
                picpath = openFileDialog.FileName;
                pictureBox20.Image = System.Drawing.Image.FromFile(openFileDialog.FileName);
